...
INSERT INTO animals (aid, aniname, anicount, anistatus, class, family, facts, size, food, habitat, anidescription, threat, sound, gamedesc)
values(2, 'Blue Whale', 38, 'Endangered', 'Mammals', 'Balaenopteridae', 'Heart of Blue whale is equal to size of volkswagen beetle Car', '40cm - height of the seat at school', 'Sees, buds, fruits', 'Deep, permanent water or open lakes.', 'Male body red-brown, head and neck black, bill blue when breeding. Female body grey-brown with short faint stripes, bill dark grey. ','drainage, salinisation', 'Blue Whale singing', 'Can you imagine a blue whale even larger than a plane? That is amazing! Its entire body is almost blue, just like the puzzle on the right, go and finish it!');
